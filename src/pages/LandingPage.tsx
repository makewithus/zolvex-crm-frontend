            ...
            <div className="w-full lg:max-w-[650px] lg:pr-4">
              ...
              <div className="flex flex-wrap items-start gap-8">
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="text-[14px] font-bold text-[#0F172A]">Secure & Reliable</h4>
                    <p className="text-[12px] text-[#64748B] mt-0.5">Enterprise-grade security</p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="text-[14px] font-bold text-[#0F172A]">Easy to Use</h4>
                    <p className="text-[12px] text-[#64748B] mt-0.5">Get started in minutes</p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="text-[14px] font-bold text-[#0F172A]">Built for Growth</h4>
                    <p className="text-[12px] text-[#64748B] mt-0.5">Scale your operations</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="px-6 py-10 bg-[#F8FAFC]">
         <div className="max-w-[1200px] mx-auto grid grid-cols-2 md:grid-cols-5 gap-4">
            {[
              ...
              <div key={i} className="bg-[#F8FAFF] p-6 rounded-lg border border-[#E5EDFF] flex flex-col items-center justify-center text-center">
                 <s.icon className="h-5 w-5 text-[#2563EB] mb-3" />
                 <div className="text-[24px] font-bold text-[#0F172A]">{s.stat}</div>
                 <div className="text-[13px] text-[#64748B] font-medium mt-1">{s.label}</div>
              </div>
            ))}
         </div>
      </section>
         ...
         <div className="max-w-[1200px] mx-auto px-6 flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-[55%] relative pl-0 lg:pl-10 mt-12 lg:mt-0">
               ...
               <div className="relative rounded-xl overflow-visible aspect-[4/3] lg:aspect-[5/4] shadow-none animate-float">
                  ...
                  {/* Floating Widget 1 */}
                  <div className="absolute top-12 -left-6 lg:-left-12 bg-white p-3.5 rounded-lg shadow-sm border border-[#E2E8F0] w-48 z-10">
                     <p className="text-[13px] text-[#64748B] mb-1">Job Status</p>
                     <div className="flex items-center gap-2 text-[15px] font-bold text-[#0F172A]">
                        <div className="h-5 w-5 rounded-full bg-[#E5EDFF] flex items-center justify-center"><CheckCircle2 className="h-3.5 w-3.5 text-[#2563EB]" /></div>
                        Completed
                     </div>
                  </div>

                  {/* Floating Widget 2 */}
                  <div className="absolute bottom-16 -left-4 lg:-left-8 bg-white p-4 rounded-lg shadow-sm border border-[#E2E8F0] w-44 z-10">
                     <p className="text-[13px] text-[#64748B] mb-1">Customer Rating</p>
                     <div className="text-[24px] font-bold text-[#0F172A] mb-1">4.8/5</div>
                     <div className="flex gap-1 text-[#2563EB]">
                        <Star className="h-4 w-4 fill-current" /><Star className="h-4 w-4 fill-current" /><Star className="h-4 w-4 fill-current" /><Star className="h-4 w-4 fill-current" /><Star className="h-4 w-4 fill-current opacity-20" />
                     </div>
                  </div>

                  {/* Floating Widget 3 */}
                  <div className="absolute bottom-8 -right-4 lg:-right-10 bg-white p-4 rounded-lg shadow-sm border border-[#E2E8F0] w-52 z-10">
                     <p className="text-[13px] text-[#64748B] mb-1">Revenue Growth</p>
                     <div className="text-[20px] font-bold text-[#2563EB] mb-0.5">+15.8%</div>
                     <p className="text-[13px] text-[#64748B] mb-3">This Month</p>
                     <div className="h-10 w-full relative">
                        <svg viewBox="0 0 100 30" className="w-full h-full stroke-[#BFDBFE] stroke-[2] fill-none stroke-linecap-round stroke-linejoin-round relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
               {[
                 ...
                 <div key={i} className="bg-white p-6 rounded-lg border border-[#E2E8F0] shadow-sm relative flex flex-col h-full transition-all duration-200 hover:scale-[1.01] hover:shadow-md cursor-default">
                    ...
                    <p className="text-[16px] text-[#475569] leading-relaxed mb-8 pr-4 flex-1">"{t.q}"</p>
                    <div className="flex items-center gap-3 mt-auto">
                       <div className="h-10 w-10 rounded-full bg-[#E5EDFF] text-[#2563EB] flex items-center justify-center font-bold">{t.letter}</div>
                       <div>
                          <div className="text-[16px] font-bold text-[#0F172A]">{t.name}</div>
                          <div className="text-[14px] text-[#64748B]">{t.role}</div>
                       </div>
                    </div>
                 </div>
               ))}
